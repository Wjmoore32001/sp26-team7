...
## App Functions
    1. Customer
        Can create an account and edit profile details (name, contact info, and payment info).
        Browse lists/calenders of upcoming classes, with features to search by class type and time.
        View class details (capacity, instructor, room, price).
        Reserve spot in class or join waitlist if class is currently full.
